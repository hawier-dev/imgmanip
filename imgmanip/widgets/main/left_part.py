...
class LeftPart(QVBoxLayout):
    def __init__(self, root_widget):
        ...
        self.images_buttons_h_box.setObjectName("images_buttons_h_box")
        # add button
        ...
        self.sort_images_button.setObjectName("sort_images_button")
        ...
        self.remove_images_button.setObjectName("remove_images_button")
    ...
    def generate_image_properties(self, file_name):
        ...
        modification_time = datetime.fromtimestamp(modification_time).strftime(
            "%Y-%m-%d %H:%M:%S"
        )
        image_mode = img.mode
        mode_to_bpp = {
